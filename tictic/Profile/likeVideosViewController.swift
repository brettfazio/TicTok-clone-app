...
import UIKit
@available(iOS 13.0, *)
class likeVideosViewController: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
...
//                self.setupView()
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        /*
        print("userID likevideo: ",UserDefaults.standard.string(forKey: "userID"))
